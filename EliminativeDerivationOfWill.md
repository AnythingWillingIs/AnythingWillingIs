...
The guarantee — "the potential always generates" — is itself a principle. It constrains the random process to exclude non-actualisation. Randomness with a guaranteed outcome is randomness with a constraint. At the level of *whether* generation occurs, this is necessity, not randomness. At the level of *which* generation occurs: unlimited potential includes unlimited real alternatives (R.4, R.9). A specific outcome from among unlimited real alternatives, with what makes it this outcome absent, requires the specificity of the outcome — the specific relationship between the actual and the alternatives — to have no source. The specificity of that relationship is specific (R.5). Under randomness, this specificity has no ground. The defence dissolves.
...
1. "Nothing" cannot be (R.2).
2. Possibility is without limitation (R.4).
3. What is generated from unlimited potential does not conflict with what is (R.7).
4. Choice is the sole candidate for how being comes into being (R.10).
5. Active exclusion — "not that" — does not survive in unlimited potential (R.11).
6. Actualisation is Will: "this is," without exclusion (R.11, Def.2).
7. Will wills as itself — not externally justified and not without basis (R.12).
